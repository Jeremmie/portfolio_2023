    ...
    return (<>
        <div className="fixed bg-melonSoft/80 backdrop-blur-md text-gunmetal dark:text-melonSoft dark:bg-gunmetal/80 flex flex-col justify-center items-center w-screen h-screen transition_darkmode">
            ...
            '>
                ...
                <div className="border-4 text-melonSoft hover:text-black border-white hover:bg-white w-10/12 text-center mt-5 flex flex-row items-center justify-between bg-gunmetal px-7 py-3 rounded-full fill-melonSoft lg:hover:fill-black">
                ...
                <div className="text-melonSoft hover:text-black border-4 border-white hover:bg-white w-10/12 text-center mt-5 flex flex-row items-center justify-between bg-gunmetal px-7 py-3 rounded-full fill-melonSoft lg:hover:fill-black">
